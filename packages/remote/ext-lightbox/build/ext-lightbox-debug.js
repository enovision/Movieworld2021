...
Ext.define('Lightbox.singleton.Lightbox', {singleton:true, alternateClassName:['ExtLightBox'], config:{}, constructor:function(config) {
  this.initConfig(config);
}, lightbox:function(thumbnail, options) {
  basicLightbox.create('\x3cimg src\x3d"' + thumbnail + '" /\x3e', {closable:true}).show();
}});
