        ...
        1: [function (e, t, o) {
            ...
            o.create = function (e, t) {
                var o = function () {
                    ...
                    return !1 !== t.beforeClose(f) && (i = function () {
                        if (t.afterClose(f), "function" == typeof e) return e(f)
                    }, (n = o).classList.remove("basicLightbox--visible"), setTimeout(function () {
                        return !1 === r(n) ? i() : (n.parentElement.removeChild(n), i())
                    }, 410), !0);
                    var n, i
                };
                !0 === t.closable && (o.onclick = function (e) {
                    var t;
                    e.target === this && (i(), "function" == typeof(t = e).stopPropagation && t.stopPropagation(), "function" == typeof t.preventDefault && t.preventDefault())
                });
                var f = {
                    element: function () {
                        return o
