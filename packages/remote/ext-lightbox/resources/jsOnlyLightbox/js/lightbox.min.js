...
function Lightbox () {
    ...
    function c (t) {
        n(t, "click", function (e) {
            s(e), u(e), j = l(t, z + "-group") || !1, V = t, A(t, !1, !1, !1)
        }, !1)
    }
    ...
    function g (t, e) {
        for (var n = m(e), o = 0; o < n.length; o++) if (l(t, "src") === l(n[o], "src") && l(t, z + "-index") === l(n[o], z + "-index") && l(t, z) === l(n[o], z)) return o
    }

    function d () {
        if (j) {
            var t = new Image, e = new Image, n = g(V, j);
    ...
    function x (t) {
        ...
        if (W.box.innerHTML = B, M && r(W.box, O + "-ie8"), W.wrapper = document.getElementById(T + "-contentwrapper"), !W.opt.hideCloseBtn) {
            ...
            l.setAttribute("id", T + "-close"), l.setAttribute("class", O + "-close"), l.innerHTML = "X", W.box.appendChild(l), n(l, "click", function (t) {
                s(t), W.close()
            }, !1)
        }
        if (!M && W.opt.closeOnClick && n(W.box, "click", function (t) {
                s(t), W.close()
            }, !1), "string" == typeof W.opt.loadingAnimation) (y = document.createElement("img")).setAttribute("src", W.opt.loadingAnimation), r(y, O + "-loading-animation"), W.box.appendChild(y); else if (W.opt.loadingAnimation) {
    ...
    function A (t, e, i, p) {
        ...
        var c;
        c = "string" == typeof t ? t : l(t, z) ? l(t, z) : l(t, "src"), L = !1, R || ("number" == typeof W.opt.animation && r(D.img, O + "-animate-transition " + O + "-animate-init"), R = !0, W.opt.onopen && W.opt.onopen(D)), W.opt && a(W.opt.hideOverflow) && !W.opt.hideOverflow || S.setAttribute("style", "overflow: hidden"), W.box.setAttribute("style", "padding-top: 0"), W.wrapper.innerHTML = "", W.wrapper.appendChild(D.img), W.opt.animation && r(W.wrapper, O + "-animate");
        var u = l(t, z + "-caption");
        if (u && W.opt.captions) {
    ...
    var y, w, I, C, k, E, H, O = "jslghtbx", T = "jslghtbx", z = "data-jslghtbx", W = this, M = !1, N = !1,
        S = document.getElementsByTagName("body")[0],
        B = '<div class="jslghtbx-contentwrapper" id="jslghtbx-contentwrapper" ></div>', L = !1, j = !1, V = !1, D = {},
        P = [], R = !1, q = [], X = !1, $ = !1;
    W.opt = {}, W.box = !1, W.wrapper = !1, W.thumbnails = [], W.thumbnails.push = function () {
        ...
        if (D.img) {
            C = e(), k = t();
            var n = W.box.offsetWidth, o = W.box.offsetHeight;
        ...
        j = !1, V = !1;
        var t = D;
        D = {}, P = [], R = !1, i(W.box, O + "-active"), i(W.wrapper, O + "-wrapper-active"), i(X, O + "-active"), i($, O + "-active"), W.box.setAttribute("style", "padding-top: 0px"), h(), M && W.box.setAttribute("style", "display: none"), W.opt && a(W.opt.hideOverflow) && !W.opt.hideOverflow || S.setAttribute("style", "overflow: auto"), W.opt.onclose && W.opt.onclose(t)
    }
}
